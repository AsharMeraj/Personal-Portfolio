...
const Skills = () => {
    return (
        <section id='skills' className='w-full h-full bg-gradient-to-t from-black to-[rgb(30,0,0)] pb-[13rem] max-[840px]:pb-[8rem] '>
            ...
            <main className='flex mt-[6rem] max-[840px]:mt-[3rem] gap-[4rem] max-[518px]:gap-[1.6rem] flex-wrap justify-center w-[38rem] max-[618px]:w-screen px-[3rem] max-[322px]:px-[1rem] m-auto max-[446px]:mt-[3rem]'>
                <motion.div className='flex flex-col items-center  justify-center rounded-full light w-[8rem] h-[8rem] max-[618px]:w-[6rem] max-[618px]:h-[6rem] max-[446px]:w-[5rem] max-[446px]:h-[5rem] animate'
                    key="logo1"
                    initial={{ y: '6rem', opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ duration: 0.6 }}
